                      ...
                      <div>
                        ...
                        <div className="space-y-2 sm:flex sm:items-center sm:justify-between sm:space-x-2 sm:space-y-0 mt-4">
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              className="border border-gray-200 rounded h-4 w-4 text-green-500 focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50"
                            />
                            <span className="ml-2">Remember me</span>
                          </label>
                          <Link
                            to="#"
                            className="inline-block text-green-600 hover:text-green-400"
                          >
                            Forgot Password?
                          </Link>
                        </div>
