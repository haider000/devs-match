...
const SignUp = () => {
  return (
    <div>
      ...
      <div
        id="page-container"
        className="flex flex-col mx-auto w-full min-h-screen bg-gray-900"
      >
        {/* <!-- Page Content --> */}
            ...
            <div className="py-6 lg:py-0 w-full md:w-8/12 lg:w-6/12 xl:w-4/12 relative">
              ...
              <div className="mb-8 text-center">
                <h1 className="text-4xl font-bold inline-flex items-center mb-1 space-x-3">
                  <svg
                    className="hi-solid hi-cube-transparent inline-block w-8 h-8 text-green-500"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  ...
                  <span className="text-white-200">Devs Match</span>
                </h1>
              ...
              <div className="flex flex-col rounded shadow-sm bg-white overflow-hidden">
                  ...
                  <div className="sm:p-5 lg:px-10 lg:py-8">
                    <form className="space-y-6">
                      <div className="space-y-1">
                        <label htmlFor="tk-pages-name" className="font-medium">
                          Name
                        </label>
                        <input
                          className="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50"
                          type="email"
                          id="tk-pages-name"
                      ...
                      <div className="space-y-1">
                        <label
                          htmlFor="tk-pages-sign-in-repeat-password"
                          className="font-medium"
                        >
                          Repeat Password
                        </label>
                        <input
                          className="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50"
                          type="password"
                          id="tk-pages-sign-in-repeat-password"
                          placeholder="Password"
                        />
                      </div>
                      <div>
                        ...
                        <div className="flex text-center text-lg font-bold w-full justify-center align-center">
                          <div className="pt-7"> OR</div>
                        </div>
                      </div>
                    </form>
                    <div>
                ...
                <div className="py-1 px-5 lg:px-2 w-full text-lg text-center bg-gray-50">
                  Already have an account!&nbsp;&nbsp;
                  <Link
                    className="font-lg text-green-600 hover:text-green-400"
                    to="/signin"
                  >
                    Login
                  </Link>
